    ...
    def parseData(self, browser):
        ...
        for tr in trs:
            ...
            if tds:
                ...
                wholeCapital = float(int(tds[5].get_text().strip().replace(',', ''))/10000.00)
                circulatingCapital = float(int(tds[6].get_text().strip().replace(',', ''))/10000.00)
